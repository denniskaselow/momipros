...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 4, 0],
...
["dart.dom.html", "dart:html", , W, {
  ...
  Geolocation: {
    ...
    watchPosition$3$enableHighAccuracy$maximumAge$timeout: function(receiver, enableHighAccuracy, maximumAge, timeout) {
      ...
      options.$indexSet(0, "timeout", C.JSInt_methods._tdivFast$1(timeout._duration, 1000));
      t1.watchId_0 = null;
    ...
    watchPosition$2$enableHighAccuracy$timeout: function($receiver, enableHighAccuracy, timeout) {
      return this.watchPosition$3$enableHighAccuracy$maximumAge$timeout($receiver, enableHighAccuracy, null, timeout);
    },
    ...
    _watchPosition$3: function(receiver, successCallback, errorCallback, options) {
      return this._watchPosition_1$3(receiver, successCallback, errorCallback, P.convertDartToNative_Dictionary(options));
    },
    _watchPosition_1$3: function(receiver, successCallback, errorCallback, options) {
  ...
  Geolocation_watchPosition_closure0: {
    "^": "Closure:10;box_0,this_1,options_2",
    call$0: function() {
      var t1, t2;
      t1 = this.this_1;
      t2 = this.box_0;
...
["", "jan.dart", , O, {
  "^": "",
  main: [function() {
    var headingDiv, speedDiv, errorDiv, e, t1, exception;
    headingDiv = document.querySelector("#heading");
    speedDiv = document.querySelector("#speed");
    errorDiv = document.querySelector("#error");
    try {
      t1 = J.watchPosition$2$enableHighAccuracy$timeout$x(window.navigator.geolocation, true, P.Duration$(0, 0, 0, 0, 0, 10)).listen$1(new O.main_closure(headingDiv, speedDiv));
      t1.onDone$1(new O.main_closure0(errorDiv));
      t1.onError$1(0, new O.main_closure1(errorDiv));
    } catch (exception) {
      t1 = H.unwrapException(exception);
      e = t1;
      J.set$innerHtml$x(errorDiv, e);
    }
  ...
  main_closure0: {
    "^": "Closure:10;errorDiv_2",
    call$0: function() {
      J.set$innerHtml$x(this.errorDiv_2, "erledigt");
    }
  },
  main_closure1: {
    "^": "Closure:11;errorDiv_3",
    call$1: function(e) {
      if (!!J.getInterceptor(e).$isPositionError)
        J.set$innerHtml$x(this.errorDiv_3, H.interceptedTypeCast(e, "$isPositionError").message);
    }
  }
},
1],
...
J.watchPosition$2$enableHighAccuracy$timeout$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver).watchPosition$2$enableHighAccuracy$timeout(receiver, a0, a1);
};
...
//# sourceMappingURL=jan.dart.js.map
